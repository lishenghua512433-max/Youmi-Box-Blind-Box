...
export const adminSettings = pgTable('admin_settings', {
  ...
  royaltyCommission: numeric('royalty_commission', { precision: 5, scale: 2 }).notNull().default('0'),
  serviceFee: numeric('service_fee', { precision: 5, scale: 2 }).notNull().default('0'),
  ...
  maxWithdraw: numeric('max_withdraw', { precision: 18, scale: 8 }).notNull().default('10000'),
